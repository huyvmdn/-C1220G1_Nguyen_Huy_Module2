...
public interface Validation {
    ...
    String CHUOI_VACHAM = "^\\w.*$";
    String SO_NGUYEN_DUONG = "^[\\d]*$";
    String SO_DIEN_THOAI = "^(090|091)[0-9]{7}$";
    String DAY = "^([0][1-9]|[12][0-9]|[3][01])[/]([0][1-9]|[1][012])[/]([1][0-9]{3}|[2][0-9]{3})$";
    String TEN = "^[\\w\\s]{4,50}";


    static void kiemTraTen(String name) throws PersonException {
     ...
     static void kiemTraNgaySinh(String name) throws PersonException {
     ...
     static boolean kiemTraLuaChon(String name, String chon) {
    ...
    static boolean checkTonTai(String lop) {
    ...
    static boolean kiemTraSoDienThoaiDuyNhat(String lop) throws PersonException {
